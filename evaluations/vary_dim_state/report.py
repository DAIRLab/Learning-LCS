...
print('------')
print('avg_training_data_size:', avg_training_data_size)
print('avg_training_data_stiffness:', avg_data_stiffness)
print('std_training_data_stiffness:', std_data_stiffness)
...
label = ['2', '8', '16', '32', '64', '128']
plt.xticks(x,labels=label)
plt.xlabel('State dimension $n_{x}$', labelpad=15)
